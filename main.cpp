...
void robotByValue(Robot c) {
    c.setBatteryLife(100);
}



// Step 3: Function to modify robot (pass by reference)
void robotByReference(Robot &c) {
    c.setBatteryLife(100);
}
...
int main() {
    ...
    cout << "Updated Battery Life (using pointer): " << ptr->getBatteryLife() << "%\n";
